...
//                .uri("http://localhost:8082/api/v1/inventory",
            ...
            if (allProductsInStock) {
                ...
                // kafka will send the 'OrderPlacedEvent' object as a message to the notification service
                kafkaTemplate.send("notificationTopic", new OrderPlacedEvent(order.getOrderNumber())); // order number is the constructor argument
